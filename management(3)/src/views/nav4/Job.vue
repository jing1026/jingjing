	...
	export default {
		...
		methods: {
			...
			getData:function (){
				...
				this.$http.post('mrecruit/list', this.qs.stringify(para)).then(data => {
				...
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						this.$confirm('确认提交吗？', '提示', {}).then(() => {
							this.listLoading = true;
							this.$http.post('mrecruit/update', this.qs.stringify(this.editForm)).then(data => {
			...
			handleDel(id) {
				this.$confirm('确认删除吗?', '提示', {}).then(() => {
					this.listLoading = true;
					this.$http.post('mrecruit/delete', this.qs.stringify({ids: id, adminId: sessionStorage.getItem('id')})).then(data => {
