<template>
	<section v-loading="listLoading">
        ...
        <el-row>
            <el-col :span="3">房租:</el-col>
            <el-col :span="6">{{data.rent}}</el-col>
        </el-row>
        <el-row>
            <el-col :span="3">付款方式:</el-col>
            <el-col :span="6">{{data.deposit}}</el-col>
        </el-row>
        <el-row>
            <el-col :span="3">房型:</el-col>
            <el-col :span="6">{{data.layout}}</el-col>
        </el-row>
        <el-row>
            <el-col :span="3">房屋面积:</el-col>
            <el-col :span="6">{{data.space}}</el-col>
        </el-row>
        <el-row>
            <el-col :span="3">朝向:</el-col>
            <el-col :span="6">{{data.position}}</el-col>
        </el-row>
        <el-row>
            <el-col :span="3">楼层:</el-col>
            <el-col :span="6">{{data.floor}}</el-col>
        </el-row>
        <el-row>
            <el-col :span="3">房屋信息:</el-col>
            <el-col :span="9" v-html="data.info.replace(/\r\n/g, '<br/>').replace(/\n/g, '<br/>').replace(/\s/g, ' ')"></el-col>
        </el-row>
        <el-row>
	...
	export default {
		...
		methods: {
			...
			getData:function (){
				...
				this.$http.post('mrent/info', this.qs.stringify({id:this.$route.query.id})).then(data => {
            ...
            examine(para){
				this.listLoading = true;
				this.$http.post('mrent/update', this.qs.stringify(para)).then(data => {
